...
```
tradingagents-frontend   latest    xxx    xxx MB
tradingagents-backend    latest    xxx    xxx MB
...
tradingagents-backend    tradingagents-backend:latest  Up
tradingagents-frontend   tradingagents-frontend:latest Up
```
