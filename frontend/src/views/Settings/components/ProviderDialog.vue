...
const presetProviders = [
  {
    ...
    api_doc_url: 'https://docs.volcengine.com/docs/82379/2373738?lang=zh',
  ...
  },
  {
    ...
    description: '火山方舟 Coding Plan 是为开发者量身定制的 AI 编程与模型订阅服务，支持 Doubao-Seed-2.0 系列、DeepSeek-V4 系列、GLM-5.2、Kimi-K2.7 等主流模型按需切换。注意：Coding Plan 专属 Base URL 为 https://ark.cn-beijing.volces.com/api/coding/v3。',
