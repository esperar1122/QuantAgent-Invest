<template>
  <div class="about">
    ...
    <div class="hero-section">
      <div class="hero-content">
        <div class="hero-text">
          <h1 class="hero-title">
            智能投研分析系统
            <span class="version-badge">Graduation Thesis</span>
          </h1>
          <p class="hero-subtitle">
            融合量化因子分析与大模型多智能体协同推理
          </p>
          <p class="hero-description">
            面向人工智能与金融投资深度融合的应用场景，针对传统大模型在股票投研中结构化数据利用不足、量化分析能力有限及可解释性较弱等问题，设计并实现自主轻量级量化因子提取与多智能体协同研判体系。
          </p>
    ...
    <div class="contact-section">
      <div class="section-header">
        <h2 class="section-title">课题系统特性</h2>
        <p class="section-subtitle">面向真实市场数据的量化特征提取与大模型多角色协同研判架构</p>
      </div>
      ...
      <div class="contact-grid">
        <div class="contact-card">
          ...
          <h4>轻量级量化因子</h4>
          <p>多维特征提取</p>
          <span class="contact-desc">涵盖趋势、动量、量价、波动率与基本面特征</span>
        </div>
        ...
        <div class="contact-card">
          ...
          <h4>全市场量化选股</h4>
          <p>自动化多因子筛选</p>
          <span class="contact-desc">全市场批量过滤与候选股票池构建</span>
        </div>
        ...
        <div class="contact-card">
          ...
          <h4>多智能体协同推理</h4>
          <p>交叉论证与博弈</p>
          <span class="contact-desc">宏观、基本面、技术与风险多角色独立研判</span>
        </div>
        ...
        <div class="contact-card">
          ...
          <h4>专业研判报告</h4>
          <p>逻辑透明可追溯</p>
          <span class="contact-desc">完整展现决策链条与多格式成果导出</span>
        </div>
      </div>
    </div>
    ...
    <div class="footer-section">
      <div class="footer-content">
        <p>毕业设计课题：融合量化因子分析与大模型多智能体协同推理的智能投研系统</p>
      </div>
    </div>
  </div>
</template>
